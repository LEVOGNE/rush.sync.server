...
- **v0.3.9** — Neuestes oeffentliches Release
- **v0.3.8** — Erste offizielle oeffentliche Version (stabil, Docker-ready, produktionsgetestet)
- **v0.1.0 – v0.3.7** — Interne Entwicklungsversionen, seit Februar 2025 taeglich entwickelt und getestet
